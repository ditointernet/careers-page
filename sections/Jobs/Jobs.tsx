...
const Jobs = () => (
  <Section id="nossas-vagas">
    <SectionWrapper>
      ...
      <Description>
        Estamos crescendo – e rápido – por isso, buscamos mais FERAs para o
        nosso time.
        <br />
        Aproveite para dar uma olhada nas nossas vagas. Pode ser que a
        oportunidade que você procurava para ir além na sua carreira esteja bem
        aqui.{" "}
      </Description>
      <Boxes>
        <a
          title="Vagas de tecnologia e produto"
          href="https://dito.hire.trakstar.com/?team_id=5567&team_id=6345"
          target="_blank"
          rel="noreferrer"
        >
          <Box>
        ...
        <a
          title="Vagas do comercial e marketing"
          href="https://dito.hire.trakstar.com/?team_id=5436&team_id=17072&team_id=8496"
          target="_blank"
          rel="noreferrer"
        >
          <Box>
            <BoxTitle>Comercial & Marketing</BoxTitle>
            <BoxLink>
              <span>Ver vagas</span>
              <svg
                width="28"
        ...
        <a
          title="Vagas de gente e gestão"
          href="https://dito.hire.trakstar.com/?team_id=26339&team_id=11035&team_id=27867&team_id=36065"
          target="_blank"
          rel="noreferrer"
        >
          <Box>
        ...
        >
          <Box>
            ...
            <BoxLink>
              ...
              >
                <path
                  d="M23.8873 8.62053C23.5988 7.72736 22.8057 7.10542 21.8681 7.03704L16.2447 6.61826L14.1279 1.41696C13.7789 0.556184 12.9485 0 12.0121 0C11.0715 0 10.2559 0.534918 9.87509 1.41565L7.75734 6.61794L2.11174 7.03867C1.1695 7.13061 0.382012 7.7676 0.105555 8.66142C-0.170574 9.55426 0.104574 10.4831 0.819434 11.0821L5.10859 14.7179L3.77768 20.1738C3.60134 20.8612 3.74758 21.5741 4.17911 22.1302C4.61457 22.692 5.29377 23.027 5.99587 23.027C5.99587 23.027 5.99587 23.027 5.9962 23.027C6.42413 23.027 6.84749 22.903 7.21391 22.6727L12.001 19.7167L16.7881 22.6727C17.1513 22.8971 17.5642 23.0156 17.982 23.0156C18.6775 23.0156 19.3551 22.6854 19.7948 22.1329C20.2293 21.5865 20.388 20.8811 20.2273 20.1852L18.8935 14.7183L23.1793 11.0857C23.8981 10.4831 24.1762 9.51533 23.8873 8.62053ZM21.9142 9.58502L16.6991 14.005L18.3176 20.6384C18.3261 20.6763 18.353 20.7921 18.2584 20.9106C18.1524 21.044 17.9718 21.0964 17.819 21.0022L12.001 17.4095L6.17581 21.0067C6.11431 21.0457 6.05542 21.0643 5.9962 21.0643C5.89772 21.0643 5.79565 21.012 5.73021 20.9272C5.67001 20.8497 5.65333 20.7627 5.68212 20.6505L7.30356 14.005L2.08426 9.58142C1.94718 9.46658 1.95209 9.33342 1.98055 9.24182C2.0064 9.15806 2.08295 9.01411 2.27991 8.99448L9.11672 8.48541L11.685 2.17566C11.7648 1.99081 11.9241 1.96333 12.0121 1.96333C12.1123 1.96333 12.2444 1.9967 12.3095 2.15603L14.8857 8.48573L21.7238 8.99513C21.9112 9.00887 21.9881 9.12731 22.0192 9.22415C22.0451 9.30398 22.0666 9.45709 21.9142 9.58502Z"
                  fill={COLORS_NEXT.BRAND.GREEN_600}
                />
              </svg>
            </BoxLink>
